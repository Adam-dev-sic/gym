...
const workouts = {
  ...
  "pec-deck-chest-fly": {
    ...
    description:
      "The Pec Deck Chest Fly is a machine-based isolation exercise that targets the pectoral muscles with minimal involvement from supporting muscle groups. Seated in the pec deck machine, the user brings the arms together in a wide arc, focusing on squeezing the chest at the peak contraction. The guided motion of the machine allows for strict form and consistent resistance, making it ideal for safely isolating the chest and achieving a strong muscle pump. This exercise is suitable for all levels and is often used as a finishing movement in chest workouts.",
    muscles: ["Chest"],
  },
  "seated-cable-fly": {
  ...
  "machine-reverse-flyes": {
    ...
    description:
      "Machine Reverse Flyes are a machine-based isolation exercise that targets the rear deltoids and upper back. Seated in the reverse fly machine, the user pushes the handles outward in a reverse hugging motion, focusing on squeezing the shoulder blades together. This exercise is excellent for improving posture, shoulder stability, and upper back strength, and is often used as a finishing movement in shoulder or back routines.",
    muscles: ["Shoulders", "Upper Back"],
  },
  ...
  "seated-dumbbell-shoulder-press": {
    ...
    description:
      "The Seated Dumbbell Shoulder Press is a compound movement that targets the deltoids, triceps, and upper chest. Performed seated with a pair of dumbbells, the movement involves pressing the weights overhead until the arms are fully extended. This exercise is excellent for building overall shoulder mass and strength, and the seated position helps stabilize the body and reduce lower back strain.",
  ...
  "ez-bar-seated-triceps-extension": {
    ...
    description:
      "The EZ-Bar Seated Triceps Extension is an overhead triceps isolation exercise performed with an EZ-bar. The angled grip of the EZ-bar reduces wrist strain and allows for a comfortable range of motion. The movement involves lowering the bar behind the head and then extending the arms upward, focusing on squeezing the triceps at the top. This exercise is excellent for building triceps mass and strength.",
    muscles: ["Triceps"],
  },
  ...
  "dumbbell-spider-curl": {
    ...
    description:
      "The Dumbbell Spider Curl is a biceps isolation exercise performed lying face down on an incline bench. This position eliminates momentum and maximizes biceps contraction throughout the movement. The exercise is effective for building biceps peak and improving muscle definition.",
    muscles: ["Biceps"],
  },
  "dumbbell-supinated-preacher-curl": {
    ...
    description:
      "The Dumbbell Supinated Preacher Curl is a biceps isolation exercise performed on a preacher bench with a supinated (palms up) grip. This grip maximizes biceps activation and helps build size and peak. The movement involves curling the dumbbells upward while keeping the upper arms stationary.",
    muscles: ["Biceps"],
  },
  ...
  "double-dumbbell-bent-over-row": {
    ...
    description:
      "The Double Dumbbell Bent Over Row is a compound back exercise performed with a dumbbell in each hand. The movement involves pulling the weights toward the torso while maintaining a bent-over position, targeting the lats, rhomboids, and biceps. This exercise allows for a greater range of motion and unilateral training compared to the barbell row.",
    muscles: ["Back", "Lats", "Biceps"],
  },
  "dumbbell-bent-over-row": {
    ...
    description:
      "The Dumbbell Bent Over Row is a unilateral back exercise performed with a single dumbbell. The movement involves pulling the weight toward the torso while maintaining a bent-over position, targeting the lats, rhomboids, and biceps. This exercise is effective for correcting muscle imbalances and improving back strength and symmetry.",
    muscles: ["Back", "Lats", "Biceps"],
  },
  "dumbbell-kelso-shrugs": {
    ...
    description:
      "Dumbbell Kelso Shrugs are a trap and upper back exercise performed in a bent-over position. The movement involves shrugging the shoulders upward while holding dumbbells, focusing on squeezing the traps and upper back. This exercise is effective for building trap size and improving upper back strength and posture.",
  ...
  "seated-cable-row": {
    ...
    description:
      "The Seated Cable Row is a back exercise performed on a cable row machine. The movement involves pulling the handle toward the torso while keeping the elbows close to the body, targeting the lats, rhomboids, and biceps. This exercise is effective for building back thickness and improving posture.",
    muscles: ["Back", "Lats", "Biceps"],
  },
  ...
  "smith-bent-over-row": {
    ...
    description:
      "The Smith Bent Over Row is a back exercise performed on a Smith machine. The movement involves pulling the bar toward the torso while maintaining a bent-over position, targeting the lats, rhomboids, and biceps. The Smith machine provides stability and safety, making it easier to focus on back activation and control.",
    muscles: ["Back", "Lats", "Biceps"],
  },
  "t-bar-chest-supported-row": {
    ...
    description:
      "The T-Bar Chest Supported Row is a back exercise performed on a T-bar row machine with chest support. The support eliminates lower back involvement, allowing for strict form and maximum activation of the lats, rhomboids, and biceps. This exercise is ideal for isolating the back muscles and reducing the risk of lower back injury.",
    muscles: ["Back", "Lats", "Biceps"],
  },
  "wide-grip-chest-supported-row": {
    ...
    description:
      "The Wide Grip Chest Supported Row is a back exercise performed on a chest-supported row machine with a wide grip. The movement involves pulling the handles toward the torso with elbows flared, targeting the upper back and rear delts. This exercise is effective for building upper back thickness and improving posture.",
    muscles: ["Back", "Lats", "Biceps"],
  },
  ...
  "handstand-hold": {
    ...
    name: "Handstand Hold",
    description:
      "The Handstand Hold is a static bodyweight exercise that develops balance, shoulder stability, and core strength. Performed by balancing the body vertically on the hands, this exercise is fundamental in gymnastics and calisthenics. It improves proprioception, upper body strength, and overall body control.",
    muscles: ["Shoulders", "Core"],
  },
  ...
  "pike-push-up-between-benches-shoulder": {
    ...
    description:
      "The Pike Push-Up Between Benches is a deeper variation of the pike push-up, performed with the hands and feet elevated on benches. This increased range of motion enhances shoulder activation and strength, making it an excellent progression toward handstand push-ups.",
    muscles: ["Shoulders", "Triceps"],
  },
  "arm-circles": {
    ...
    name: "Arm Circles",
    description:
      "Arm Circles are a dynamic warm-up exercise that improves shoulder mobility, flexibility, and blood flow. Performed by rotating the arms in large circles, this movement prepares the shoulders for more intense upper body exercises and helps prevent injuries.",
    muscles: ["Shoulders"],
  },
  "clap-push-up": {
    ...
    name: "Clap Push-Up",
    description:
      "The Clap Push-Up is an explosive push-up variation that develops upper body power, speed, and chest activation. Performed by pushing off the ground with enough force to clap the hands before landing, this exercise enhances fast-twitch muscle fibers and athletic performance.",
    muscles: ["Chest", "Triceps"],
  },
  "archer-push-up": {
    ...
    name: "Archer Push-Up",
    description:
      "The Archer Push-Up is a unilateral push-up variation that increases chest and triceps strength. Performed by shifting the body weight to one side while extending the opposite arm, this exercise challenges stability, control, and muscle coordination. It is an excellent progression toward one-arm push-ups.",
    muscles: ["Chest", "Triceps"],
  },
  "cobra-push-up": {
    ...
    name: "Cobra Push-Up",
    description:
      "The Cobra Push-Up is a push-up variation that stretches the chest and works the triceps. The movement involves lowering the body to the ground and then arching the chest upward, mimicking the cobra yoga pose. This exercise improves chest flexibility, triceps strength, and spinal mobility.",
    muscles: ["Chest", "Triceps"],
  },
  "chest-dips": {
    ...
    name: "Chest Dips",
    description:
      "Chest Dips are a dip variation that targets the lower chest and triceps. Performed on parallel bars with a forward lean, the movement involves lowering the body below the bars and pressing back up. This exercise is effective for building chest mass, triceps strength, and upper body power.",
    muscles: ["Chest", "Triceps"],
  },
  "resistance-band-push-up": {
    ...
    description:
      "The Resistance Band Push-Up is a push-up variation performed with a resistance band looped across the back. The added resistance increases chest and triceps activation, making the exercise more challenging and effective for building strength and muscle mass.",
    muscles: ["Chest", "Triceps"],
  },
  "weighted-push-up": {
    ...
    description:
      "The Weighted Push-Up is a push-up variation performed with added weight, such as a weight plate or vest. The increased resistance enhances chest, shoulder, and triceps strength, making the exercise more effective for building muscle mass and power.",
    muscles: ["Chest", "Triceps"],
  },
  "ring-dips": {
  ...
  "push-up": {
    ...
    name: "Push-Up",
    description:
      "The Push-Up is a classic bodyweight exercise that targets the chest, shoulders, and triceps. Performed by lowering the body to the ground and pressing back up, this exercise is fundamental for building upper body strength, endurance, and muscle definition.",
    muscles: ["Chest", "Shoulders", "Triceps"],
  },
  "negative-push-up": {
    ...
    description:
      "The Negative Push-Up is a push-up variation that focuses on the eccentric (lowering) phase of the movement. Performed by lowering the body slowly to the ground, this exercise increases time under tension and enhances muscle growth and strength.",
    muscles: ["Chest", "Triceps"],
  },
  "weighted-chin-up-bicep": {
    ...
    description:
      "The Weighted Chin Up is a chin-up variation performed with added weight, such as a weight belt or vest. The movement targets the biceps and back, increasing strength and muscle mass. This exercise is ideal for advanced athletes seeking to progress beyond bodyweight chin-ups.",
    muscles: ["Biceps", "Back"],
  },
  "chin-up-bicep": {
    ...
    name: "Chin-Up",
    description:
      "The Chin-Up is a pull-up variation performed with a supinated (palms facing you) grip. This grip emphasizes the biceps while still engaging the back muscles. The movement involves pulling the chin above the bar, building upper body strength and muscle mass.",
    muscles: ["Biceps", "Back"],
  },
  "knee-close-grip-push-up": {
    ...
    description:
      "The Knee Close Grip Push-Up is a push-up variation performed from the knees with the hands placed close together. This position emphasizes the triceps and chest, making the exercise more accessible for beginners or as a triceps isolation movement.",
  ...
  "diamond-push-up": {
    ...
    description:
      "The Diamond Push-Up is a push-up variation performed with the hands together in a diamond shape under the chest. This grip increases triceps activation while still engaging the chest. The movement is effective for building triceps size and strength.",
    muscles: ["Triceps", "Chest"],
  },
  "weighted-dips": {
    ...
    name: "Weighted Dips",
    description:
      "Weighted Dips are a dip variation performed with added weight, such as a weight belt or vest. The movement targets the triceps and chest, increasing strength and muscle mass. This exercise is ideal for advanced athletes seeking to progress beyond bodyweight dips.",
    muscles: ["Triceps", "Chest"],
  },
  "incline-close-grip-push-up": {
    ...
    description:
      "The Incline Close Grip Push-Up is a push-up variation performed on an incline surface with the hands placed close together. This position emphasizes the triceps and chest, making the exercise more accessible for beginners or as a triceps isolation movement.",
    muscles: ["Triceps", "Chest"],
  },
  "weighted-bench-dips": {
    ...
    description:
      "Weighted Bench Dips are a triceps isolation exercise performed with the hands on a bench and added weight on the lap. The movement involves lowering the body below the bench and pressing back up, targeting the triceps and improving upper body strength.",
    muscles: ["Triceps"],
  },
  "reverse-hand-push-up": {
    ...
    description:
      "The Reverse Hand Push-Up is a push-up variation performed with the hands rotated so the fingers point toward the feet. This position increases triceps activation and wrist flexibility, making the exercise effective for building triceps strength and mobility.",
    muscles: ["Triceps"],
  },
  "full-planche-push-up": {
    ...
    description:
      "The Full Planche Push-Up is an advanced push-up variation performed in the full planche position, with the body parallel to the ground and supported only by the hands. This exercise requires exceptional strength, balance, and control, targeting the triceps, shoulders, and core.",
  ...
  "pike-push-up-tricep": {
    ...
    name: "Pike Push-Up",
    description:
      "The Pike Push-Up is a triceps-focused push-up variation performed with the hips elevated and the body in an inverted V position. The movement emphasizes the triceps and shoulders, making it an effective exercise for building upper body strength.",
  ...
  "decline-diamond-push-up": {
    ...
    description:
      "The Decline Diamond Push-Up is a push-up variation performed with the feet elevated and the hands together in a diamond shape. This position increases triceps activation and adds intensity to the movement, making it effective for building triceps size and strength.",
    muscles: ["Triceps", "Chest"],
  },
  "pike-push-up-between-benches-tricep": {
    ...
    name: "Pike Push-Up Between Benches",
    description:
      "The Pike Push-Up Between Benches is a deeper pike push-up variation performed with the hands and feet elevated on benches. This increased range of motion enhances triceps and shoulder activation, making it an excellent progression toward advanced push-up variations.",
    muscles: ["Triceps", "Shoulders"],
  },
  "negative-pull-up": {
    ...
    description:
      "The Negative Pull-Up is a pull-up variation that focuses on the eccentric (lowering) phase of the movement. Performed by lowering the body slowly from the top position, this exercise increases time under tension and enhances back and biceps strength.",
    muscles: ["Back", "Biceps"],
  },
  flag: {
    ...
    name: "Flag",
    description:
      "The Flag is an advanced static hold that requires full body tension and exceptional strength in the back, core, and shoulders. Performed by holding the body horizontally while gripping a vertical pole, this exercise demonstrates elite levels of strength, balance, and control.",
  ...
  "weighted-chin-up-back": {
    ...
    name: "Weighted Chin Up",
    description:
      "The Weighted Chin Up is a chin-up variation performed with added weight, such as a weight belt or vest. The movement targets the back and biceps, increasing strength and muscle mass. This exercise is ideal for advanced athletes seeking to progress beyond bodyweight chin-ups.",
    muscles: ["Back", "Biceps"],
  },
  "suspension-inverted-row": {
    ...
    description:
      "The Suspension Inverted Row is a back exercise performed with suspension straps. The movement involves pulling the chest toward the handles while keeping the body straight, targeting the back and biceps. This exercise improves upper body strength, grip, and stability.",
    muscles: ["Back", "Biceps"],
  },
  "wide-grip-rear-pull-up": {
    ...
    description:
      "The Wide Grip Rear Pull-Up is a pull-up variation performed with a wide grip, pulling the chest behind the bar. This movement emphasizes the upper back and biceps, improving back width and strength.",
    muscles: ["Back", "Biceps"],
  },
  "pull-up-neutral-grip": {
    ...
    description:
      "The Pull-Up Neutral Grip is a pull-up variation performed with the palms facing each other. This grip emphasizes the biceps and forearms while still engaging the back muscles. The movement is effective for building upper body strength and muscle mass.",
    muscles: ["Back", "Biceps"],
  },
  "muscle-up": {
    ...
    name: "Muscle-up",
    description:
      "The Muscle-up is a powerful pull-up variation that transitions into a dip at the top of the movement. This exercise targets the back, chest, triceps, and shoulders, requiring significant strength, coordination, and explosiveness. It is a hallmark skill in advanced calisthenics and gymnastics.",
  ...
  "close-grip-pull-up": {
    ...
    description:
      "The Close Grip Pull Up is a pull-up variation performed with the hands close together. This grip emphasizes the lower lats and biceps, providing a unique stimulus compared to traditional wide-grip pull-ups. The movement is effective for building back and arm strength.",
    muscles: ["Back", "Biceps"],
  },
  "pull-up-wide-grip": {
    ...
    description:
      "The Pull-Up Wide Grip is a pull-up variation performed with a wide grip, targeting the lats and upper back. The movement is effective for building back width and improving upper body strength.",
    muscles: ["Back", "Lats"],
  },
  "chin-up-back": {
    ...
    name: "Chin-Up",
    description:
      "The Chin-Up is a pull-up variation performed with a supinated (palms facing you) grip. This grip emphasizes the biceps while still engaging the back muscles. The movement is effective for building upper body strength and muscle mass.",
    muscles: ["Back", "Biceps"],
  },
  "rings-pull-up": {
    ...
    name: "Rings Pull-Up",
    description:
      "The Rings Pull-Up is a pull-up variation performed on gymnastic rings, increasing instability and muscle activation. The movement targets the back, biceps, and shoulders, and requires significant strength, balance, and control.",
  ...
  "ring-muscle-up": {
    ...
    name: "Ring Muscle Up",
    description:
      "The Ring Muscle Up is a muscle-up variation performed on gymnastic rings. The movement transitions from a pull-up to a dip, targeting the back, chest, triceps, and shoulders. This exercise requires significant strength, coordination, and control.",
    muscles: ["Back", "Chest", "Triceps", "Shoulders"],
  },
  "front-lever": {
    ...
    name: "Front Lever",
    description:
      "The Front Lever is an advanced static hold that requires full body tension and exceptional strength in the back, core, and shoulders. Performed by holding the body horizontally while gripping a bar, this exercise demonstrates elite levels of strength, balance, and control.",
    muscles: ["Back", "Core", "Shoulders"],
  },
  "pull-up": {
    ...
    name: "Pull-Up",
    description:
      "The Pull-Up is a classic bodyweight exercise that targets the back and biceps. Performed by pulling the chin above a bar, this exercise is fundamental for building upper body strength, endurance, and muscle definition.",
    muscles: ["Back", "Biceps"],
  },
  "weighted-pull-up": {
    ...
    description:
      "The Weighted Pull-Up is a pull-up variation performed with added weight, such as a weight belt or vest. The movement targets the back and biceps, increasing strength and muscle mass. This exercise is ideal for advanced athletes seeking to progress beyond bodyweight pull-ups.",
    muscles: ["Back", "Biceps"],
  },
};
function Workout() {
